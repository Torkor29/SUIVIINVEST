...
export const PROVIDER_CATALOG: readonly {
  ...
  { providerId: 'credit_agricole', providerName: 'Crédit Agricole', implemented: true, apiSupported: false, importFormats: ['ca-csv'], requiredConfig: ['region'], requiredSecrets: ['CA_LOGIN', 'CA_PASSWORD'], notes: 'Lecture seule, collecte via export de comptes.' },
  ...
  { providerId: 'trade_republic', providerName: 'Trade Republic', implemented: true, apiSupported: false, importFormats: ['trade-republic-csv', 'trade-republic-pdf'], requiredConfig: [], requiredSecrets: [], notes: 'Pas d’API publique : import de relevés uniquement.' },
...
export const SYNC_RUNS: readonly SyncRunDto[] = [
  ...
  { syncRunId: 'run-1040', providerId: 'credit_agricole', connectionId: 'conn-ca', trigger: 'SCHEDULED', startedAt: '2026-09-21T05:30:00Z', finishedAt: '2026-09-21T05:30:21Z', status: 'SUCCESS', created: 34, updated: 0, skipped: 12, errors: 0, durationMs: 21120, message: null },
